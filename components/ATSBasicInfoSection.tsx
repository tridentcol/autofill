...
export default function ATSBasicInfoSection({ sheetIndex, sectionIndex, fields }: ATSBasicInfoSectionProps) {
  const { cuadrillas, workers, getWorkerById } = useDatabaseStore();
  ...
  // Obtener valor actual del campo equipo_elabora
  useEffect(() => {
  ...
  }, [currentFormData, sheetIndex, sectionIndex, activeCuadrillas, getWorkerById]);
