...
export default function Home() {
  ...
  const { isAdmin } = useDatabaseStore();
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <div className="flex gap-3">
          {/* Botón de Base de Datos (solo para admins) */}
          {isAdmin() && (
            <button
              onClick={() => setShowDatabaseAdmin(!showDatabaseAdmin)}
      ...
      {/* Gestor de base de datos (modal) - Solo admins */}
      {showDatabaseAdmin && (
